...
function DashListProduct() {
    ...
    return (
        ...
        <div onClick={()=>setShow(false)} role="dialog" aria-modal="true" className={(show && "show")  + " d-block fade modal bg-overlayOnly"} tabindex="-1" aria-labelledby="contained-modal-title-vcenter">
