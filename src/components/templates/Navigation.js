                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="w-100 justify-content-center fw-bold mt-3 ml-3 ml-lg-0 mt-lg-0">
                            <Nav className="myNavbarItems">
                                ...
                                <Col className="p-0 d-flex flex-col justify-content-lg-end" lg={12}>
                                    <Button ref={props.modalcart} variant="none" className="myClickStyleNone text-lg-center mt-3 mt-lg-0 px-0 position-relative" onClick={() => setCartModalShow(true)}>
