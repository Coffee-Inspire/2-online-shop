...
function NavDashboard(props) {
    ...
    return (
        ...
        <Navbar.Collapse id="" className="flex-column mt-3 navbar-animation">
            ...
            <Nav.Link className="navDashLink d-flex align-items-center" href="/dashboard/listproduct">
            ...
            <Nav.Link className="navDashLink d-flex align-items-center" href="/dashboard/profile">
            ...
            <Nav.Link className="navDashLink d-flex align-items-center" href="/dashboard/home">
            ...
            <Nav.Link className="navDashLink d-flex align-items-center" href="/dashboard/about">
