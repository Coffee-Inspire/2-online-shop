...
function Footer() {
    ...
    let waInd = `+62 813-2702-29505`
    let templateMsgInd = 'Halo saya tertarik dengan barang ini'
    let waTwn = `+886 976 256 013`
    let templateMsgTwn = 'cao ni ma'
    let instagram = `@phanenshopgram`
    let instagramUrl = `@phanenshopgram`
    let email = `phanen_shop@yahoo.mail.com`
        ...
        <Container fluid className="px-4">
            ...
            <Row className="d-flex justify-content-center text-center myFooterRow">
                <Col className="d-flex justify-content-center my-4" xs={12} lg={12}>
                    <div className="myFooterImageFrame">
                        <img
                            alt=""
                            src={emblem}
                            className="myFooterImage"
                        />
                    </div>
                </Col>
                <Col className="fw-bold mb-5" xs={11} lg={6}>
                    {description}
                </Col>
                <Col className="d-flex flex-lg-row flex-wrap justify-content-center mb-5 ml-lg-5 pl-lg-5" xs={12} lg={9}>
                    <Col className="mb-5 mb-lg-0 d-flex flex-column" xs={11} lg={3}>
                        <Col className="text-center text-lg-start pb-2" xs={12} lg={12}>
                            <span className="fw-bold">Order for Indonesian</span>
                        </Col>
                        <Col className="text-center text-lg-start px-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
                                <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h6zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H5z"/>
                                <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
                            </svg>
                            <span className="myFooterContactItems ml-2">{waInd}</span>
                        </Col>
                    </Col>
                    <Col className="mb-5 mb-lg-0 d-flex flex-column" xs={11} lg={3}>
                        <Col className="text-center text-lg-start pb-2" xs={12} lg={12}>
                            <span className="fw-bold">Order for Taiwan</span>
                        </Col>
                        <Col className="text-center text-lg-start px-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16">
                                <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h6zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H5z"/>
                            ...
                            <span className="myFooterContactItems ml-2">{waTwn}</span>
                        </Col>
                    </Col>
                    <Col className="mb-5 mb-lg-0 d-flex flex-column" xs={11} lg={3}>
                        <Col className="text-center text-lg-start pb-2" xs={12} lg={12}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                            ...
                            <span className="myFooterContactItems ml-2">{instagram}</span>
                        </Col>
                    </Col>
                    <Col className="mb-5 mb-lg-0 d-flex flex-column" xs={11} lg={3}>
                        <Col className="text-center text-lg-start pb-2" xs={12} lg={12}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                            ...
                            <span className="myFooterContactItems ml-2">{email}</span>
                        </Col>
                    </Col>
                </Col>
